	...
	<path d="M9 11.4C9 10.9333 12 10 12 10C12 10 15 10.9333 15 11.4C15 15.1333 12 17 12 17C12 17 9 15.1333 9 11.4Z" stroke="#333333" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
</svg>
    </template>
    <script>
    export default {
